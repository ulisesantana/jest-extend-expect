...
describe("Cost report should", () => {
  ...
  it("compute total cost based in all expenses", () => {
    ...
    it("compute total cost for each category", () => {
        ...
        expect(report.expenses.groceries.total).toBe(sample.expenses.groceries.total);
        expect(report.expenses.transportation_expenses.total).toBe(sample.expenses.transportation_expenses.total);
    });
